...
independent enough to warrant their own subagent (e.g., data archaeology
on a large sample tree, PDF build test, systematic variable surveys across
many files). Spawn these as background subagents writing to separate
output files, then integrate their results into your artifact. You
retain judgment — subagents handle execution. See `methodology/03a-orchestration.md` §3a.5.
...
Delete the stub after confirming. This is independent of exploration and can be
sub-delegated.
